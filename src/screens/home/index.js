  ...
  return (
    ...
    <header className="App-header">
      <div className="container">
        ...
        <p className="homeParagraph"> <img src={SilverDrum} className="picLeft" alt="silver drumset" />She is well-versed in both digital and traditional analog techniques. She also works with field sounds and found sounds.
        ...
        <p className="homeParagraph"> <img src={GoldDrum} className="picRight" alt="gold drumset" />She currently does not have a studio set-up, but is able to run sessions from any available studio in your area. She also does mobile 
