  ...
  return (
    ...
    <header className="App-header">
      <div className="container">
        <p className="homeParagraph"> <img src={Tape} className="picRight" alt="analog tape machine" /> Joni Elfers is a sonic facilitator and audio engineer. She is experienced with tracking, mixing, and mastering. She puts her emphasis on 
        ...
        <p className="homeParagraph"> <img src={SilverDrum} className="picLeft" alt="analog tape machine" /> She is well versed in both digital and traditional analog techniques. She also works with field sounds and found sounds.
        ...
        <p className="homeParagraph"> <img src={GoldDrum} className="picRight" alt="analog tape machine" /> She currently does not have a studio set up, but is able to run sessions from any available studio in your area. She also does mobile 
