  ...
  return (
    <div className="App" id="homenav">
      <div className="App-header">
        ...
        <div className="row">
          <img src={Tape} className="picRight" alt="analog tape machine" />
        ...
        <div className="row">
          <img src={SilverDrum} className="picLeft" alt="silver drumset" />
          <p className="homeParagraph"> 
        ...
        <div className="row">
          <img src={GoldDrum} className="picRight" alt="gold drumset" />
          <p className="homeParagraph"> 
